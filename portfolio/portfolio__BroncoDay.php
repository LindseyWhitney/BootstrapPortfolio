...
?>
    ...
    <!-- Cover Image -->
    <div class="coverImage coverImage__BroncoDay hidden-xs">
      <img class="logo__BroncoDay hidden-xs" alt="Bronco Day main graphic, cropped." src="../images/portfolio/BroncoDay__coverImage--logo.png">
    </div> <!-- /.coverImage -->
    ...
    <div class="container portfolio__content--backdrop">
      ...
      <div class="introSection">
        ...
        <div class="row hidden-xs hidden-sm">
          ...
          <section class="introSection__CreativeBrief introSection__CreativeBrief--BroncoDay col-sm-5">
            ...
            <dl>
              <dt class="col-sm-3 dd__BroncoDay">Audience:</dt>
              <dd class="col-sm-9 dd__BroncoDay">prospective students, ages 18-20</dd>
              <dt class="col-sm-3 dd__BroncoDay">Tone/Feel:</dt>
              <dd class="col-sm-9 dd__BroncoDay">fun, contemporary, &ldquo;hip&rdquo;</dd>
              <dt class="col-sm-3 hidden-md dd__BroncoDay">Elements:</dt>
              <dd class="col-sm-9 hidden-md dd__BroncoDay">&ldquo;Bronco Day,&rdquo; Boise State colors</dd>
            </dl>
          </section>
      ...
      <div class="portfolioDisplay">
          <img alt="Bronco Day front t-shirt design." src="../images/portfolio/BroncoDay__1.jpg">
          <img alt="Bronco Day back t-shirt design." src="../images/portfolio/BroncoDay__2.jpg">
          <img alt="Bronco Day t-shirt design close-up." src="../images/portfolio/BroncoDay__3.png">
